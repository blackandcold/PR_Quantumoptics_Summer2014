...
\begin{itemize} % TODO Numbers in picture
...
\textbf{Summary of approach}\\ % Besser aufteilen und Beschreiben
...
% TODO the position:%Da solltet ihr etwas mehr schreiben: So was wie: Mit dem Ansatz x(t)=x_0eî\omega_t in die Differentialgleichung mit treibender Kraft ....
...
% TODO Beschreibung mit Erwartungen von figure 5 (Tabelle)
\begin{figure}[H]
 \centering
 \pgfplotstabletypeset[
...
\end{figure}
% TODO ordnen und mehr beschreiben
...
% TODO factor in:%Ihr müsst aufpassen, dass euer Fit auch wirklich das FWHM ergibt. Desweiteren müsst ihr schauen, ob ihr omega_m=2pi*fm und gamma_m=2Pi*FWHM nehmt.
...
%TODO Leider sind die Werte / REchnung nicht nachvollziehbar. Da fehlt noch die Angabe der gemessenen Vpp auf der Quadrantendiode. Wenn ich mir eure Exceltabelle von Git runterlade, stehen da auch ganz andere Werte für die Kalibrierung als die ihr im Protokoll habt. Bitte überprüft das.
